    ...
    return (
        <div className='footer'>
            ...
            <div className='copyright-details'>
                <p className='footer-copyright'>&#169; 2020 copyright all right reserved<br /><span>Designed with ❤️ by SohitVish</span></p>
            </div>
        </div>
    )
}
